...
const PrecedenceTab = (function () {
    ...
    /**
     * Calculates the end-point of a link, shortened to stop at the edge
     * of the target node's circle.
     */
    ...
    /**
     * Calculates and stores the target (x, y) positions for the
     * K&W (Kamada-Kawai-style) hierarchical layout.
     */
    ...
    /**
     * Animates the transition from the force layout to the K&W layout.
     */
    ...
    /**
     * Updates node/link colors based on precedence violations.
     */
    ...
    /**
     * Applies error styling to links involved in a precedence violation.
     */
    ...
    /**
     * Public method to update colors on the chart, e.g., on drag/drop.
     */
    ...
    /**
     * Public method to resize the SVG and update layouts.
     */
    function resize() {
